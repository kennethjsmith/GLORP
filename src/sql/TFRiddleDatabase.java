...
public class TFRiddleDatabase {
	...
	private void addRiddles(Statement theStatement) {
		try {
			  ...
			  theStatement.executeUpdate("INSERT INTO tfriddles VALUES('Ancient Egyptians respected and revered all wild animals.', 'False', 'True', 'Okay so maybe they were a little barbaric. They hunted large wild animals for sport.' )");
			  theStatement.executeUpdate("INSERT INTO tfriddles VALUES('Some Egyptian doctors had specialized fields of study.', 'True', 'False', 'These specialists even had specific names. Dentists were known as “doctors of the tooth,” while the term for proctologists literally translates to “shepherd of the anus.”' )");
